...
const defaultSpanTheme = { md: false, ehr: false, narrative: false };
const SpanContext = React.createContext(defaultSpanTheme);
                    ...
                    {spanTheme => (
                        <Note>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Span variant={variant} type={spanTheme['narrative']}>
                                        Sed cursus ante.{' '}
                                        <Span variant={variant} type={spanTheme['md']}>
                                            Duis sagittis ipsum.
                                        </Span>{' '}
                                        Dapibus diam.
                                    </Span>
